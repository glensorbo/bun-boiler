...
| `user.http`         | `GET /api/user`, `GET /api/user/:id`, `DELETE /api/user/:id`, `PATCH /api/user/:id/role`, `POST /api/user/:id/reset-password`                                                                     |
| `auth.http`         | `POST /api/auth/signup`, `POST /api/auth/login`, `POST /api/auth/create-user`, `POST /api/auth/set-password`, `POST /api/auth/change-password`, `POST /api/auth/refresh`, `POST /api/auth/logout` |
