...
Repository logic is tested indirectly through service and controller tests using `mockUserRepository` from `@backend/utils/test/mockUserRepository`. This keeps tests fast and database-free.
