...
Repository logic is tested indirectly through service and controller tests using `mockUserRepository` from `@backend/test-helpers/mockData`. This keeps tests fast and database-free.
